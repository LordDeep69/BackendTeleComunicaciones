...
class Cliente(Base):
    ...
    notificaciones = relationship('Notificacion', back_populates='cliente', primaryjoin='Cliente.id==Notificacion.id_cliente')
    registros_uso = relationship('RegistroUsoServicios', back_populates='cliente', primaryjoin='Cliente.id==RegistroUsoServicios.id_cliente')